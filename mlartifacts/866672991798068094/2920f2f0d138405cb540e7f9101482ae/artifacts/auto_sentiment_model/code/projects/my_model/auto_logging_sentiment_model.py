...
class AutoLoggingSentimentModel(BaseModelV3):
    ...
    def _generate_and_log_requirements(self):
        ...
        try:
            ...
            from ..shared_utils.requirements_analyzer import analyze_code_paths
            ...
            requirements = analyze_code_paths(code_paths)
            ...
            with tempfile.NamedTemporaryFile(mode="w", suffix=".txt", delete=False) as f:
                ...
                f.write("# Generated by smart requirements analyzer\n\n")
            ...
            self.log_model_info(f"Generated {len(requirements)} minimal requirements:")
            for req in requirements:
